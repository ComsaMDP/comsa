...
export const Button = ({ children, className, variant = 'light', onClick }: Props) => {
  const base =
  ...
  const primary = 'border-primary bg-primary hover:bg-gray-100 hover:border-gray-100 hover:text-primary';
  ...
  const styles = clsx(base, { primary, light, dark }[variant], className);
